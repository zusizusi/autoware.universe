...
std::optional<autoware_utils::Polygon2d> getRoundaboutArea(
  lanelet::ConstLanelet assigned_lane, lanelet::LaneletMapConstPtr lanelet_map_ptr)
{
  // assigned_lane is a lanelet that has "roundabout" attribute.
  const std::string area_id_str = assigned_lane.attributeOr("roundabout", "else");
