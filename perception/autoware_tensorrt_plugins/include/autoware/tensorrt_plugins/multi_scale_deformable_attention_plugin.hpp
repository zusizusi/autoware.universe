...
#ifndef AUTOWARE__TENSORRT_PLUGINS__MULTI_SCALE_DEFORMABLE_ATTENTION_PLUGIN_HPP_
#define AUTOWARE__TENSORRT_PLUGINS__MULTI_SCALE_DEFORMABLE_ATTENTION_PLUGIN_HPP_
...
constexpr char const * const kMULTI_SCALE_DEFORMABLE_ATTENTION_PLUGIN_NAME{
  "MultiScaleDeformableAttentionPlugin"};
constexpr char const * const kMULTI_SCALE_DEFORMABLE_ATTENTION_PLUGIN_VERSION{"1"};
constexpr char const * const kMULTI_SCALE_DEFORMABLE_ATTENTION_PLUGIN_NAMESPACE{""};

namespace autoware::tensorrt_plugins
{

class MultiScaleDeformableAttentionPlugin : public nvinfer1::IPluginV3,
                                            public nvinfer1::IPluginV3OneCore,
                                            public nvinfer1::IPluginV3OneBuild,
                                            public nvinfer1::IPluginV3OneRuntime
{
public:
  explicit MultiScaleDeformableAttentionPlugin(const std::string & name) noexcept;
...
#endif  // AUTOWARE__TENSORRT_PLUGINS__MULTI_SCALE_DEFORMABLE_ATTENTION_PLUGIN_HPP_
